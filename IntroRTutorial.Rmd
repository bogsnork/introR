...
* Section 2: [Importing data](#section2) (xx minutes)
* Section 3: [Functions and operators](#section3) (xx minutes)
* Section 4: [Summary statistics](#section4) (xx minutes)
* Section 5: [Plots and charts](#section5) (xx minutes) 
...
Any dataset consists of a number of elements (e.g. a measurement, species name, presence/absence), each of which has a value.  In **R** values will normally be one of the following types:
...
factor(c("brophytes", "graminoids", "vascular plants","graminoids")) 
```
...
In **R** you give data a name by using the `<-` assignment operator.
